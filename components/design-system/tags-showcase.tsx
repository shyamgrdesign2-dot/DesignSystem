...
function TPCloseIcon({ size = 16, color = "#717179" }: { size?: number; color?: string }) {
  return (
  ...
  return (
    ...
    >
      ...
      {dismissible && (
        ...
        >
          <span className="inline-flex flex-shrink-0"><TPCloseIcon size={14} color={text} /></span>
        </button>
      )}
    </span>
  )
...
function Banner({
  ...
  const style = intensity === "filled" ? color.dark : color.light
